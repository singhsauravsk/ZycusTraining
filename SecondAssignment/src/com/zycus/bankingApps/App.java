...
public class App {
	...
	private static void withdrawButton() {
		...
		String confirmWithdraw = transaction.withdraw(accountNo, amount);
		
		if(confirmWithdraw.equals("Transcation Successful")) {
			branch.printAccountDetails(branch.getAccount(accountNo));
		}
		else {
			System.out.println(confirmWithdraw);
		}
	}
	...
	private static void depositButton() {
		...
		String confirmDeposit = transaction.deposit(accountNo, amount);
		
		if(confirmDeposit.equals("Transcation Successful")) {
			branch.printAccountDetails(branch.getAccount(accountNo));
		}
		else {
			System.out.println(confirmDeposit);
		}
	}
	...
	private static void transferButton() {
		...
		String confirmTransfer = transaction.transferFund(accountNo, payeeAccountNo, amount);
		
		if(confirmTransfer.equals("Transcation Successful")) {
			branch.printAccountDetails(branch.getAccount(accountNo));
		}
		else {
	...
	private static void listAccountsByHolderName() {
		...
		if(holderSet.size() == 0) {
			System.out.println("There is no account linked with "+holderName);
		}
		else {
	...
	private static void listAllAccountsSortedAccount() {
		List <Account> sortedList = allAccounts;
